...
func (p Print) Execute(table symbol.SymbolTable, ast *symbol.AST) interface{} {
	...
	label04 := generator.AddLabel()
	label05 := generator.AddLabel()
	label06 := generator.AddLabel()

	if len(p.Expression) == 1 {
		...
		value01 := p.Expression[0].(abstract.Expression).GetValue(table, ast)
		value02 := p.Expression[1].(abstract.Expression).GetValue(table, ast)
		if value01.Type == symbol.INT {
			generator.AddIf(value01.Value.(string), "9999999827968.00", "==", label01)
			generator.AddGoto(label02)
			generator.PutLabel(label01)
			generator.AddPrint("c", "110")
			generator.AddPrint("c", "105")
			...
			generator.AddGoto(label03)
			generator.PutLabel(label02)
			generator.AddPrint("d", value01.Value.(string))

		} else if value01.Type == symbol.FLOAT {
			generator.AddIf(value01.Value.(string), "9999999827968.00", "==", label01)
			generator.AddGoto(label02)
			generator.PutLabel(label01)
			generator.AddPrint("c", "110")
			...
			generator.AddGoto(label03)
			generator.PutLabel(label02)
			generator.AddPrint("f", value01.Value.(string))
		} else if value01.Type == symbol.CHAR {
			generator.AddIf(value01.Value.(string), "9999999827968.00", "==", label01)
			generator.AddGoto(label02)
			generator.PutLabel(label01)
			generator.AddPrint("c", "110")
			...
			generator.AddPrintString()
			generator.AddEnv(strconv.Itoa(table.GetSize()))
			generator.SetStack("P", value01.Value.(string))
			generator.AddComment("Aqui se debe llamar a la funcion printString")
			generator.AddCall("printString")
			generator.AddPrint("c", "32")
			generator.ReturnEnv(strconv.Itoa(table.GetSize()))
		} else if value01.Type == symbol.STRING {
			generator.AddIf(value01.Value.(string), "9999999827968.00", "==", label01)
			generator.AddGoto(label02)
			generator.PutLabel(label01)
			generator.AddPrint("c", "110")
			...
			generator.AddPrint("c", "32")
			generator.ReturnEnv(strconv.Itoa(table.GetSize()))
		} else if value01.Type == symbol.BOOL {
			labelExit := generator.AddLabel()
			for _, label := range value01.LabelTrue {
				generator.PutLabel(label.(string))
			}
			generator.AddPrint("c", "116")
			generator.AddPrint("c", "114")
			...
			generator.AddPrint("c", "101")
			generator.AddGoto(labelExit)
			for _, label := range value01.LabelFalse {
				generator.PutLabel(label.(string))
			}
			generator.AddPrint("c", "102")
			generator.AddPrint("c", "97")
			...
			generator.PutLabel(labelExit)
			generator.AddPrint("c", "32")
		} else if value01.Type == symbol.ARRAY {
			tempVar := table.GetVar(value01.Value.(string))
			temporal01 := generator.AddTemporal()
			temporal02 := generator.AddTemporal()
			tempSizeThis := generator.AddTemporal()
			tempChar := generator.AddTemporal()
		...
		generator.PutLabel(label03)
		if value02.Type == symbol.INT {
			generator.AddIf(value02.Value.(string), "9999999827968.00", "==", label06)
			generator.AddGoto(label04)
			generator.PutLabel(label06)
			generator.AddPrint("c", "110")
			generator.AddPrint("c", "105")
			generator.AddPrint("c", "108")
			generator.Println()
			generator.AddGoto(label05)
			generator.PutLabel(label04)
			generator.AddPrint("d", value02.Value.(string))

		} else if value02.Type == symbol.FLOAT {
			generator.AddIf(value02.Value.(string), "9999999827968.00", "==", label06)
			generator.AddGoto(label04)
			generator.PutLabel(label06)
			generator.AddPrint("c", "110")
			...
			generator.AddGoto(label05)
			generator.PutLabel(label04)
			generator.AddPrint("f", value02.Value.(string))
		} else if value02.Type == symbol.CHAR {
			generator.AddIf(value02.Value.(string), "9999999827968.00", "==", label06)
			generator.AddGoto(label04)
			generator.PutLabel(label06)
			generator.AddPrint("c", "110")
			...
			generator.AddPrintString()
			generator.AddEnv(strconv.Itoa(table.GetSize()))
			generator.SetStack("P", value02.Value.(string))
			generator.AddComment("Aqui se debe llamar a la funcion printString")
			generator.AddCall("printString")
			generator.Println()
			generator.ReturnEnv(strconv.Itoa(table.GetSize()))
		} else if value02.Type == symbol.STRING {
			generator.AddIf(value02.Value.(string), "9999999827968.00", "==", label06)
			generator.AddGoto(label04)
			generator.PutLabel(label06)
			generator.AddPrint("c", "110")
			...
			generator.Println()
			generator.ReturnEnv(strconv.Itoa(table.GetSize()))
		} else if value02.Type == symbol.BOOL {
			labelExit := generator.AddLabel()
			for _, label := range value02.LabelTrue {
				generator.PutLabel(label.(string))
			}
			generator.AddPrint("c", "116")
			generator.AddPrint("c", "114")
			...
			generator.AddPrint("c", "101")
			generator.AddGoto(labelExit)
			for _, label := range value02.LabelFalse {
				generator.PutLabel(label.(string))
			}
			generator.AddPrint("c", "102")
			generator.AddPrint("c", "97")
			...
			generator.PutLabel(labelExit)
			generator.Println()
		} else if value02.Type == symbol.ARRAY {
			tempVar := table.GetVar(value02.Value.(string))
			temporal01 := generator.AddTemporal()
			temporal02 := generator.AddTemporal()
			tempSizeThis := generator.AddTemporal()
			tempChar := generator.AddTemporal()
		...
		} else if value02.Type == symbol.NIL {
			generator.AddIf(value02.Value.(string), "9999999827968.00", "==", label06)
			generator.PutLabel(label06)
			generator.AddPrint("c", "110")
			generator.AddPrint("c", "105")
