...
func (v *BaseSwiftgrammVisitor) VisitNative_function(ctx *Native_functionContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSwiftgrammVisitor) VisitAssign_bl(ctx *Assign_blContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSwiftgrammVisitor) VisitList_print(ctx *List_printContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSwiftgrammVisitor) VisitArray_functions(ctx *Array_functionsContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseSwiftgrammVisitor) VisitAssign_vector(ctx *Assign_vectorContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSwiftgrammVisitor) VisitExtern_params(ctx *Extern_paramsContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSwiftgrammVisitor) VisitDeclare_array_bl(ctx *Declare_array_blContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseSwiftgrammVisitor) VisitExp_matriz(ctx *Exp_matrizContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseSwiftgrammVisitor) VisitType_matrix(ctx *Type_matrixContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseSwiftgrammVisitor) VisitDefinition_matrix(ctx *Definition_matrixContext) interface{} {
	return v.VisitChildren(ctx)
}
